function streetFighterSelection(fighters, position, moves) {
  ...
  moves.forEach((move) => {
    ...
    hovered.push(fighters[pos[0]][pos[1]]);
  });
  return hovered;
}
...
// some Arcade back in the 90s or emulating it nowadays with the numerous emulators for retro consoles.
...
//  vertically; that means that if I'm in the leftmost and I try to go left again I'll get to the rightmost
